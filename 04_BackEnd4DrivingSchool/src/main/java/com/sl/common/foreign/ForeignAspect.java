package com.sl.common.foreign;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.service.IService;
import com.sl.common.foreign.anno.ForeignCascade;
import com.sl.common.foreign.anno.ForeignField;
import com.sl.common.foreign.anno.ForeignField.ForeignFields;
import com.sl.common.foreign.info.ForeignFieldInfo;
import com.sl.common.foreign.info.ForeignTableInfo;
import com.sl.common.util.Classes;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:com/sl/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* com.sl.service..*.remove*(..))")
    ...
    @Around("execution(* com.sl.service..*.save*(..)) || execution(* com.sl.service..*.update*(..)) ")
