                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="name" name="name"
                                                       value="${user.name}" maxlength="20" class="form-control" placeholder="姓名">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="phone" name="phone"
                                                       value="${user.phone}" maxlength="20" class="form-control" placeholder="电话">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="trait" name="trait"
                                                       value="${user.trait}" maxlength="100" type="text" class="form-control" data-role="tagsinput"
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input id="interests" name="interests"
                                                       value="${user.interests}" maxlength="100" type="text" class="form-control" data-role="tagsinput"
