                        ...
                        <div class="body table-responsive">
                            <div class="menus">
                                <div class="search-box input-group">
                                    ...
                                    <div class="form-line datetime-input">
                                        <input type="date" name="endDay" class="form-control" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${result.endDay}" />" placeholder="结束日期">
                                    </div>
                                    <span class="input-group-addon">
                                        <i class="material-icons">search</i>
                                    </span>
                                    <div class="form-line keyword">
                                        <input name="keyword" type="text" class="form-control" value="${result.keyword}" placeholder="主题、内容等">
                                    </div>
